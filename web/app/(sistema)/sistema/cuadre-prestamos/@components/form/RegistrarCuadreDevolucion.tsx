...
export default function RegistrarCuadreDevolucion() {
  ...
  const agregarCuadrePrestamo = async (): Promise<void> => {
    try {
      ...
      const { status, data } = await axios.post(
        `${config.apiUrl}/cuadreprestamos/devolucion/${selectedRow?.id}`,
        {
          ...values,
        },
        {
  ...
  }, [rowExcelSelected, selectedRow?.montoTotal, setFieldValue]);
