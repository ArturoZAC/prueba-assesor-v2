...
import { ActionType, ContextMenuOption, TablaDatosLeasing } from "./TablaDatosLeasing";
import { PiMicrosoftExcelLogoFill } from "react-icons/pi";
import * as XLSX from "xlsx"
import { useAuth } from "@/context/useAuthContext";
import { toast } from "sonner";

export function TablaGeneralLeasing<TData extends RowData>({
  search,
  data,
  columns,
  modalRenderAdd,
  ...
  const table = useReactTable<TData>({
    ...
    state: {
      globalFilter,
      pagination: { pageIndex: 0, pageSize: pagination.limit },
    },
