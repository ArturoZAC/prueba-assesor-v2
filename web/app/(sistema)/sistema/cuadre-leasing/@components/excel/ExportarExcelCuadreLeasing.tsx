...
export default function ExportarExcelCuadreLeasing() {
  ...
  const {
    ...
    onSubmit: async (values) => {
      const response = await fetch(`${config.apiUrl}/cuadreleasing/exportar/tabla-excel`, {
        method: 'POST',
        headers: {
    ...
    <div>
      <form onSubmit={handleSubmit}>
        <h2 className="mb-8 text-3xl font-medium text-center font_kanit text-secondary-main">
          Filtros de Exportación - Cuadre Leasing
        </h2>
