...
export default function EditarConsultoriaFlujo({ id }: { id?: number }) {
  ...
  async function obtenerFlujo() {
    const response = await axios.get(`${config.apiUrl}/flujo-consultoria/${id}`, {
  ...
  const editarFlujoPersonal = async (values: EditarFlujoPersonalValues): Promise<void> => {
    ...
    try {
      const res = await axios.post(`${config.apiUrl}/flujo-consultoria/${id}`, values, {
        withCredentials: true,
      });
      ...
      <form onSubmit={handleSubmit} className="space-y-6 h-auto"  >
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <InputForm label="ETPS" name="flujo.etps" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.etps)} />
            </div>
            <div>
            ...
            <div>
              <InputForm label="Servicios Fondos" name="flujo.serviciosFondos" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.serviciosFondos)} />
            </div>
            <div>
            ...
            <div>
              <InputForm label="Otros Gastos Totales" name="flujo.otrosGastosTotal" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.otrosGastosTotal)} />
            </div>
            <div>
            ...
            <div>
              <InputForm label="Utilidad Operativa" name="flujo.utilidadOperativa" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.utilidadOperativa)} />
            </div>
            <div>
              <InputForm label="Impuestos" name="flujo.impuestos" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.impuestos)} placeholder="hola" />
            </div>
            <div>
              <InputForm label="Utilidad Neta" name="flujo.utilidadNeta" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.utilidadNeta)} />
            </div>
            <div>
              <InputForm label="Flujo de Caja" name="flujo.flujoCaja" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.flujoCaja)} />
            </div>
            <div>
              <InputForm label="Capital de Trabajo" name="flujo.capitalTrabajo" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.capitalTrabajo)} />
            </div>
            <div>
              <InputForm label="Flujo de Caja Libre" name="flujo.flujoCajaLibre" type="number" onChange={handleChange} onBlur={handleBlur} value={String(values.flujo.flujoCajaLibre)} />
            </div>
          </div>
        </div>
