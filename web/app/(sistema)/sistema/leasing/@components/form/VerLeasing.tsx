...
import EditarLeasing from "./EditarLeasing";
import { useEffect, useState } from "react";
import { useAuth } from "@/context/useAuthContext";
import axios from "axios";
import { PrestamoAnulado } from "../../../prestamos/@componentes/types/TypeDataPrestamoAPI";

export default function VerLeasing() {
    const {
        selectedRow,
        // setSelectedRow,
        setModalContent,
        ...
        const traerCuadres = async () => {
            try {
                ...
                const request = await axios.get(
                    `${config.apiUrl}/leasing/leasing-anulados/${selectedRow.id}`,
                    {
    ...
    return (
        <div className="w-full">
            ...
            <div className="grid w-full gap-5 lg:grid-cols-2">
                ...
                <div className="w-full">
                    <h2 className="mb-3 text-lg font-bold text-center text-secondary-main">
                        Leasing Tipo Anulados o Nota de Crédito
                    </h2>
