...
export default function AgregarCuadreFacturacion() {
  ...
  const agregarCuadrePrestamo = async (): Promise<void> => {
    try {
      ...
      const { status, data } = await axios.post(
        `${config.apiUrl}/cuadrefacturacion 
        `,
        {
          ...values,
        },
  ...
  const {
    ...
    initialValues: {
      ...
      numeroCuadre: selectedRow?.numeroCuadre || ''
    },
        ...
        <div className="grid w-full gap-5 lg:grid-cols-2">
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 gap-4 mb-5 md:grid-cols-2">
              ...
              <div className="w-full">
                ...
                />
                <Errors errors={errors.numeroCuadre} touched={touched.numeroCuadre} />
              </div>
              <div className="w-full">
                <InputForm
                  label="DOC. Cuadre"
          ...
          <div className="w-full max-h-[410px] overflow-y-auto mt-4">
            ...
            <SubirDatosFacturacion
              ...
              headers={headers}
              textAlert="Selecciona un registro del Excel para realizar el cuadre"
